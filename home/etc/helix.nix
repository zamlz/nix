  ...
  programs.helix = {
    ...
    themes = {
      navi = {
        ...
        "ui.gutter" = { };
        "ui.gutter.selected" = { };
        "ui.help" = { fg = "gray"; modifiers = ["italic"]; };
        "ui.highlight" = { };
        "ui.highlight.frameline" = { };
        "ui.linenr" = { fg = "gray"; };
        "ui.linenr.selected" = { fg = "yellow"; modifiers = ["bold"]; };
        "ui.menu" = { fg = "gray"; modifiers = ["italic"]; };
        ...
        "ui.statusline.insert" = { fg = "red"; };
        "ui.statusline.select" = { fg = "green"; };
        "ui.statusline.separator" = { fg = "black"; };
        "ui.text" = { };
        "ui.text.focus" = { };
        "ui.text.inactive" = { };
        "ui.text.info" = { };
        ...
        "ui.virtual.jump-label" = {fg = "magenta"; };
        "ui.virtual.ruler" = { bg = "black"; modifiers = ["dim"]; };
        ...
        "markup.heading.1" = {fg = "red"; modifiers = ["bold" "underlined"]; };
        "markup.heading.2" = {fg = "blue"; modifiers = ["bold" "underlined"]; };
        "markup.heading.3" = {fg = "green"; modifiers = ["bold" "underlined"]; };
        "markup.heading.4" = {fg = "magenta"; modifiers = ["bold" "underlined"]; };
        "markup.heading.5" = {fg = "cyan"; modifiers = ["bold" "underlined"]; };
        "markup.heading.6" = {fg = "yellow"; modifiers = ["bold" "underlined"]; };
        "markup.list" = "red";
